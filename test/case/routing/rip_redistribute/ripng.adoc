...
Verifies that RIPng can redistribute routes from other protocols.
...
. Verify R2 (RIPng) learns R3's OSPF routes via redistribution
. Verify R3 (OSPF) learns R2's RIPng routes via redistribution
