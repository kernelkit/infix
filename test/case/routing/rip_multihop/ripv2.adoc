...
Verifies RIPv2 functionality across multiple hops with three routers in a
...
image::topology.svg[RIPv2 Multi-hop topology, align=center, scaledwidth=75%]
...
. Verify R2 has two RIPv2 neighbors
