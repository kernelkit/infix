=== OSPFv2 Point-to-Multipoint Hybrid

ifdef::topdoc[:imagesdir: {topdoc}../../test/case/routing/ospf_point_to_multipoint_hybrid]

==== Description

Verify OSPFv2 point-to-multipoint hybrid (broadcast) interface type by
...
image::topology.svg[OSPFv2 Point-to-Multipoint Hybrid topology, align=center, scaledwidth=75%]
