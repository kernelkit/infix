...
Verify NTP server operating in server mode, syncing from upstream while serving clients.

This test validates server mode where devices synchronize from upstream NTP servers
while simultaneously serving time to downstream clients. It creates a two-tier hierarchy:
