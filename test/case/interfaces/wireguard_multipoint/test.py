...
Network layout:
- Server (192.168.0.2, 2001:db8:3c4d:02::2) with nsserver namespace (192.168.0.1, 2001:db8:3c4d:02::100)
- Client1 (192.168.1.2, 2001:db8:3c4d:01::2) with nsclient1 namespace (192.168.1.1, 2001:db8:3c4d:01::100)
- Client2 (no data subnet)
...
Security boundaries:
- nsclient1 can reach all WireGuard IPs (10.0.0.1, .2, .3 and fd00:0::1, ::2, ::3)
- nsserver can reach server and client1 WireGuard IPs, but NOT client2 (blocked by allowed-ips)
