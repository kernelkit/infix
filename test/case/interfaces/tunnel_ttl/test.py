...
with infamy.Test() as test:
    ...
    with test.step(f"Configure {tunnel} tunnel from R1 to R3, with R2 as intermediate router"):
        ...
        parallel(
            lambda: r1.put_config_dicts({"ietf-interfaces": {
                "interfaces": {
                    "interface": [{
                        "name": r1["west"],
                        "ipv4": {
            ...
            lambda: r2.put_config_dicts({"ietf-interfaces": {
                "interfaces": {
                    "interface": [{
                        "name": r2["west"],
                        "ipv4": {
            ...
            lambda: r3.put_config_dicts({"ietf-interfaces": {
                "interfaces": {
                    "interface": [{
                        "name": r3["west"],
                        "ipv4": {
