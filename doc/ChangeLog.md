...
- Drop meta version namespace prefix in generated factory-, failure-,
  and test-config.  This prevents migrate scripts from running on a
  file that's already in the correct syntax.
