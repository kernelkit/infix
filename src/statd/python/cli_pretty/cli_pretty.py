...
class PadFirewall:
    ...
    def table_width(cls):
        ...
        return cls.zone_locked + cls.zone_name + cls.zone_type + cls.zone_interfaces \
            + cls.zone_services
    ...
    if to_zone == "HOST":
        ...
        if zone_config:
            ...
            if action == 'accept':
                ...
                # Zone has service exceptions (conditional access)
...
def show_firewall_zone(json, zone_name=None):
    ...
    if zone_name:
        ...
        hdr = (f"{'':<{PadFirewall.zone_locked}}"
               ...
               f"{'MEMBERS':<{PadFirewall.zone_interfaces}}"
        ...
        for zone in zones:
            ...
            # First row: name, interfaces, services
            interfaces = compress_interface_list(interface_list) if interface_list else "(none)"
            print(f"{locked:<{PadFirewall.zone_locked}}"
                  f"{name:<{PadFirewall.zone_name}}"
                  f"{'ifaces':<{PadFirewall.zone_type}}"
            ...
            if network_list:
                ...
                print(f"{'':<{PadFirewall.zone_locked}}"
                      ...
                      f"{'networks':<{PadFirewall.zone_type}}"
                      f"{networks}")
