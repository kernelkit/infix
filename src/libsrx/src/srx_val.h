...
int srx_set_item(sr_session_ctx_t *, const sr_val_t *, uint32_t, const char *, ...)
	__attribute__ ((format (printf, 4, 5)));
int srx_set_str(sr_session_ctx_t *, const char *, uint32_t, const char *fmt, ...)
	 __attribute__ ((format (printf, 4, 5)));
int srx_set_bool(sr_session_ctx_t *session, bool ena, uint32_t opts, const char *fmt, ...)
	 __attribute__ ((format (printf, 4, 5)));
