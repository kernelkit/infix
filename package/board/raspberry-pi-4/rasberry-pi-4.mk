define RASPBERRY_PI_4_LINUX_CONFIG_FIXUPS
	...
	$(call KCONFIG_ENABLE_OPT,CONFIG_DRM_V3D)
	$(call KCONFIG_ENABLE_OPT,CONFIG_DRM_VC4)
	...
	$(call KCONFIG_ENABLE_OPT,CONFIG_TOUCHSCREEN_EDT_FT5X06)
	$(call KCONFIG_ENABLE_OPT,CONFIG_DRM_PANEL_RASPBERRYPI_TOUCHSCREEN)
